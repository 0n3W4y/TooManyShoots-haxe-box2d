...
class PlayerActor extends Actor{
	...
	private var world_scale:Float = Actor.world_scale;
	private var world:B2World = Actor.world;
	...
	public function new(parent:DisplayObjectContainer, location:Point, initVel:Point){
		...
		playerSprite.graphics.drawCircle(0, 0, 15);
		...
		bodyDefinition.position.set (100/world_scale, 100/world_scale);
